...
ใต้คลิปอยู่ดี · สิ่งที่พิสูจน์ได้เพิ่ม: ส่งค่าเดียวกัน (title/visibility) ซ้ำสองระดับ — ทั้งบนสุด
และใน `platformSpecificData` — แล้วผลออกมาถูกต้องทั้งคู่ (ข้อ 3 กับ 4) แต่การทดสอบนี้แยกไม่ออก
ว่า "platformSpecificData ไม่ทับ" หรือ "platformSpecificData ทับแล้วบังเอิญตรงกัน" เพราะสองค่า
เท่ากันอยู่แล้ว — ระดับไหนชนะยังไม่ถูกพิสูจน์ (ทดสอบครั้งหน้าถ้าอยากรู้จริงต้องส่งค่าต่างกัน
สองระดับ)
