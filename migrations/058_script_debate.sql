...
('script_debate_lenses', '[{"key":"hook_maximalist","name":"Hook Maximalist","instruction":"มุมมองการเขียนรอบนี้ — Hook Maximalist: โฟกัสพลังหยุดนิ้วสูงสุด: 3 วินาทีแรกต้องแรงจนคนยิงแอดต้องหยุดดู เปิดด้วยตัวเลข/ความเสียหาย/คำถามที่แทงใจกลุ่มเป้าหมาย กล้าตัดเนื้อหาที่ไม่เสริม hook ทิ้ง ทุกประโยคต้องสร้างเหตุผลให้ดูต่ออีก 3 วินาที ห้ามเปิดด้วยการอธิบายพื้นหลังหรือทักทาย"},{"key":"skeptic_editor","name":"Skeptic Editor","instruction":"มุมมองการเขียนรอบนี้ — Skeptic Editor: โฟกัสความแม่นและความน่าเชื่อถือ: ทุก claim ต้องเป็นสิ่งที่คนวงในยืนยันได้จริง ห้าม oversell ห้ามตัวเลขมั่ว ห้ามสัญญาผลลัพธ์ ถ้าไม่ชัวร์ให้พูดแบบมีเงื่อนไข เนื้อหาต้องลึกระดับที่มือใหม่เขียนไม่ได้ และห้ามแนะนำอะไรที่ขัดนโยบาย Meta ตรงๆ"},{"key":"target_viewer","name":"Target Viewer","instruction":"มุมมองการเขียนรอบนี้ — Target Viewer: เขียนจากมุมคนดูเป้าหมายของรอบนี้ตรงๆ: ใช้ภาษาและศัพท์ที่คนกลุ่มนี้พิมพ์คุยกันจริง เล่าสถานการณ์ที่เขากำลังเจออยู่ให้รู้สึกว่านี่คือเรื่องของเขาเอง ตอบ pain ให้จบในคลิปเดียว ไม่อวดฉลาดเกินคนดู"}]')
