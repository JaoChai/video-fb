...
SELECT 'scene_myth',
       ...
       E'- tip: {"pill":"ส่วนที่จริง","rows":[{"t":"ส่วนที่จริงของความเชื่อนี้"},{"t":"สิ่งที่ควรทำแทน"}]}\n' ||
...
('page_likes_make_ads_cheaper',
 ...
 'grey-operator', TRUE, 'ข้อเท็จจริงถูก แต่ยังไม่มีเอกสารที่อ้างชื่อได้ — ห้ามขึ้นจอจนหาแหล่งได้', NULL, 2),
...
('boost_post_equals_ads_manager',
 ...
 'account-buyer', TRUE, 'ข้อเท็จจริงถูก แต่ยังไม่ได้อ่านหน้าเอกสารของ Meta เอง — ห้ามขึ้นจอจนยืนยัน', NULL, 2),
