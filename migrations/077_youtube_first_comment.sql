-- 077: ข้อความคอมเมนต์ต้อนรับใต้คลิป YouTube
--
-- ระบบส่งคลิปผ่าน Zernio ซึ่งรับ platformSpecificData.firstComment แล้วโพสต์คอมเมนต์
-- ใต้คลิปให้ (เอกสาร docs.zernio.com/platforms/youtube บอกว่าปักหมุดด้วย แต่ live test
-- 2026-07-31 พบว่าไม่ปัก — ถ้าอยากได้หมุดต้องปักเองใน YouTube Studio, YouTube Data API
-- เองก็ปักหมุดคอมเมนต์ไม่ได้อยู่แล้ว) เราจึงไม่ต้องมี OAuth ของ YouTube เอง
--
